...
export const findAll = async (req, res) => {
    try {
        ...
        const { count, rows } = await PompaAirDistribusi.findAndCountAll({
            where: dateFilter,
...
export const create = async (req, res) => {
    const { pompa_operasi, frekuensi_inverter, ampere_meter, output_power, pressure_gauge, pressure_pipa, timestamp } = req.body;
    try {
