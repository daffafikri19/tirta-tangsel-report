...
import PreChlorine from "../models/pre_chlorine.js";
...
export const findAll = async (req, res) => {
    try {
        ...
        const { count, rows } = await PreChlorine.findAndCountAll({
            where: dateFilter,
...
export const create = async (req, res) => {
    try {
        ...
        const duplicateRecord = await PreChlorine.findOne({
            where: {
                [Sequelize.Op.and]: [
        ...
        const lastRecord = await PreChlorine.findOne({
            order: [['timestamp', 'DESC']]
        });
        ...
        const newRecord = await PreChlorine.create({
            chlorinator,
            timestamp: inputTime
        })
